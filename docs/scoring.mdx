...
This is separate from **challenge-level scoring** (how operators set `Score` values on players), which is part of the [Challenge Spec](challenges#challenge-level-scoring).
