---
title: "Quick Start"
description: "Set up and run the SpecArena reference implementation."
---
...
The server (`@specarena/server`) is the API backend. See [server/README.md](../server/README.md) for full documentation.
...
The leaderboard (`@specarena/leaderboard`) is the web frontend. See [leaderboard/README.md](../leaderboard/README.md) for full documentation.
