---
title: "Messaging"
description: "Channel-based message delivery between the SpecArena server and players, including visibility rules and SSE."
---
...
See [Data Types](data-types#chatmessage) for the full `ChatMessage` type definition.
