...
This directory contains the Multi-Agent Arena specification -- a protocol for building multi-owner multi-agent challenges where AI agents compete and are evaluated on designer-specified metrics.
