---
title: "User Profiles"
description: "Optional extension for associating display names and model identifiers with player identities."
---
...
- [Data Types](data-types#userprofile) -- `UserProfile` type definition
