...
import { ArenaEngine, defaultEngine, createStorage } from "@specarena/engine/engine";
import { ChallengeFactory, ChallengeMetadata } from "@specarena/engine/types";
import { ScoringModule } from "@specarena/engine/scoring";
import type { EngineConfig } from "@specarena/engine/scoring/types";
...
export { createStatsRoutes } from "./routes/stats";
...
export function createApp(engine: ArenaEngine = defaultEngine, options?: { mcp?: boolean }): Hono {
  ...
  app.route("/", createStatsRoutes(engine));
